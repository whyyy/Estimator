...
namespace Estimator.Testrail.Model
{
    public class TestrailDataProvider
    {
        ...
        List<TestRun> GetTestRuns()
        {
            ...
            {
                _testRuns.Add(new TestRun(testRun.Name, testRun.ID, testRun.PassedCount, testRun.Description, testRun.MilestoneID, testRun.UntestedCount, testRun.FailedCount, testRun.CustomStatus1Count));
            }
            return _testRuns;
        }
    }
